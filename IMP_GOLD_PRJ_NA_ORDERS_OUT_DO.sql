1. populate_orders_out_na_temp_table

--release date: 21/07/2022
truncate table @DB_LEVEL@_na_cld_osc_gold.orders_out_na_temp ;

insert into @DB_LEVEL@_na_cld_osc_gold.orders_out_na_temp 
(
accountservicesales ,
account_type_aop ,
accountam ,
...
'' proshipmentnumber ,
cast('' as double) as quantityordered , 
...
from (select * from @DB_LEVEL@_na_cld_osc_gold.pos_na where intrachannelflag <> 'YES') ps
...
invalidate metadata @DB_LEVEL@_na_cld_osc_gold.orders_out_na_temp ;

2. populate_orders_out_na_table
