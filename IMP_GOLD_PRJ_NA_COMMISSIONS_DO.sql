...
,stg.namedaccountsplit
,stg.officetype
,case when stg.product_family = pf.product_family and pf.standard_product = 'SP1' then 'TRUE'
else 'FALSE'
end as sp1productflag
,stg.sp1targetaccountflag
,case when stg.product_family = pf.product_family and pf.standard_product = 'SP2' then 'TRUE'
else 'FALSE'
end as sp2productflag
,stg.sp2targetaccountflag
,stg.splitpercent
...
on stg.product_family = pf.product_family;
...
select 
stg.account_type as account_type,
stg.accountam as accountam,
stg.accountcsm as accountcsm,
stg.accountlead as accountlead,
stg.accountpresence as accountpresence,
stg.accountservicesalfes as accountservicesalfes,
stg.accountsubtype as accountsubtype,
stg.accounttype as accounttype,
stg.activated as activated,
stg.account_type_aop as account_type_aop,
stg.advanced_data_center_specialization as advanced_data_center_specialization,
stg.anixtergraybarcdwflag as anixtergraybarcdwflag,
stg.aop_account_name as aop_account_name,
stg.aop_category as aop_category,
stg.billtoaccountrole as billtoaccountrole,
...
stg.billtocustomercustomertype1 as billtocustomercustomertype1,
...
stg.billtocustomertype1 as billtocustomertype1,
...
stg.billtoindustry1 as billtoindustry1,
stg.billtoindustrycode1 as billtoindustrycode1,
...
stg.channelproductgrouping as channelproductgrouping,
stg.coe as coe,
stg.country as country,
stg.customerpurchaseordernumber as customerpurchaseordernumber,
stg.customerrequestdate as customerrequestdate,
stg.data_last_refreshed as data_last_refreshed,
stg.dcpowerfinanceparent as dcpowerfinanceparent,
stg.dcpowerprofitcenter as dcpowerprofitcenter,
...
stg.endcustomercustomertype1_2 as endcustomercustomertype1_2,
stg.endcustomerenterpriseindustry as endcustomerenterpriseindustry,
stg.endcustomerenterpriseindustry2 as endcustomerenterpriseindustry2,
stg.endcustomergsc as endcustomergsc,
stg.endcustomergsc_flag as endcustomergsc_flag,
stg.endcustomerindustry as endcustomerindustry,
stg.endcustomerindustry1 as endcustomerindustry1,
stg.endcustomermarket as endcustomermarket,
stg.endcustomername as endcustomername,
stg.endcustomername2 as endcustomername2,
stg.endcustomernumber as endcustomernumber,
stg.endcustomerparentaccount as endcustomerparentaccount,
stg.endcustomerparentname as endcustomerparentname,
...
stg.exchangerateused as exchangerateused,
stg.extendedlistprice as extendedlistprice,
stg.extendedstandardcost as extendedstandardcost,
stg.f3 as f3,
stg.f4 as f4,
stg.firstdestinationflag as firstdestinationflag,
stg.gbu as gbu,
stg.gbu_cleaned as gbu_cleaned,
stg.gbu_cleaned_groups as gbu_cleaned_groups,
stg.growth_target as growth_target,
stg.invoicedate as invoicedate,
stg.invoicelinenumber as invoicelinenumber,
stg.invoicenumber as invoicenumber,
stg.legacysizecategory as legacysizecategory,
stg.lesbilltomajorclass as lesbilltomajorclass,
stg.lesbilltominorclass as lesbilltominorclass,
stg.alicecommissionoverridepercent as alicecommissionoverridepercent,
stg.lesunitsflag as lesunitsflag,
stg.level_6 as level_6,
stg.listprice as listprice,
stg.lob as lob,
stg.monthlycost as monthlycost,
stg.netsalesrevenue as netsalesrevenue,
stg.newlescrossref2 as newlescrossref2,
stg.office_no as office_no,
stg.office_location as office_location,
stg.office_website as office_website,
stg.ordercoordinator as ordercoordinator,
stg.ordercreatedate as ordercreatedate,
stg.partnerlevelstandardized as partnerlevelstandardized,
stg.partnertypestandardized as partnertypestandardized,
stg.partnerwebfolderid as partnerwebfolderid,
stg.partnerwebquotenumber as partnerwebquotenumber,
stg.phone_area_code as phone_area_code,
stg.phone_number as phone_number,
stg.plant as plant,
stg.plantdescription as plantdescription,
stg.product_category as product_category,
stg.product_family as product_family,
...
stg.proshipmentnumber as proshipmentnumber,
stg.quantityshipped as quantityshipped,
stg.quoteid as quoteid,
...
stg.right_f3 as right_f3,
stg.right_right_country as right_right_country,
stg.right_right_office_location as right_right_office_location,
stg.sales_area as sales_area,
stg.sales_region as sales_region,
stg.sales_territory as sales_territory,
stg.salesdistrictname as salesdistrictname,
stg.salesdistrictnumber as salesdistrictnumber,
stg.salesofficefamily as salesofficefamily,
stg.salesofficename as salesofficename,
sp1.third_office_id as salesofficenumber,
stg.salesofficenumberjoin as salesofficenumberjoin,
...
stg.salesregionname as salesregionname,
stg.salesregionnumber as salesregionnumber,
stg.salesrepemail as salesrepemail,
stg.salesrepid as salesrepid,
stg.salesrepname as salesrepname,
stg.sapoemtag as sapoemtag,
stg.sapsalesorganization as sapsalesorganization,
stg.segment as segment,
stg.selling_motion as selling_motion,
stg.sfr_category as sfr_category,
stg.shipdate as shipdate,
stg.shipmentcarriername as shipmentcarriername,
stg.shiptoaccountrole as shiptoaccountrole,
stg.shiptocustomeraddress as shiptocustomeraddress,
stg.shiptocustomercity as shiptocustomercity,
stg.shiptocustomercustomertype1 as shiptocustomercustomertype1,
...
stg.shiptocustomerpostalcodejoin as shiptocustomerpostalcodejoin,
...
stg.smsbatteriesonlyflag as smsbatteriesonlyflag,
stg.smsbatteryrbsm as smsbatteryrbsm,
stg.smscontractenddate as smscontractenddate,
stg.smscontractexpiredate as smscontractexpiredate,
stg.smscontractpms as smscontractpms,
stg.smscontractsequence as smscontractsequence,
stg.smscontractstartdate as smscontractstartdate,
stg.smscontractstatus as smscontractstatus,
stg.smscustomertype as smscustomertype,
stg.smsequipmentsegment as smsequipmentsegment,
stg.smssiteid as smssiteid,
stg.smstagnumber as smstagnumber,
stg.smsticketnumber as smsticketnumber,
stg.soldtocustomercustomertype1 as soldtocustomercustomertype1,
stg.soldtocustomerenterpriseindustry as soldtocustomerenterpriseindustry,
stg.soldtocustomergsc as soldtocustomergsc,
...
stg.soldtocustomerstandardizedname as soldtocustomerstandardizedname,
stg.soldtocustomervertical as soldtocustomervertical,
stg.sourceorder as sourceorder,
...
on stg.SalesOfficeNumber = sp1.office_id 
  ...
  AND sp1.product_family like concat("%",stg.product_family,"%")
  AND sp1.territory like concat("%",nullif(stg.sales_territory,''),"%") 
...
on stg.SalesOfficeNumber=cast(sp1_v.office_id as string)
    ...
    AND sp1_v.product_family like concat("%",stg.product_family,"%")
    AND sp1_v.territory like concat("%",nullif(stg.sales_territory,''),"%") 
...
/*Below query fetches records where FirstOfficeIDSplit% =1 and retains the records*/
select
stg.account_type ,
stg.account_type_aop ,
stg.accountam ,
...
/*Below query fetches records where FirstOfficeIDSplit% < 1  and splits records to have a row corresponding to 1st office id.*/
select
stg.account_type ,
stg.account_type_aop ,
stg.accountam ,
...
/*Below query fetches records where FirstOfficeIDSplit% <1 AND SecondOfficeIDSplit% >0 and splits records to have a row corresponding to 2nd office id*/
select
stg.account_type ,
stg.account_type_aop ,
stg.accountam ,
...
/*Below query fetches records where FirstOfficeIDSplit% <1 AND SecondOfficeIDSplit% >0 and AND ThirdOfficeIDSplit% > 0
 splits records to have a row corresponding to 3rd office id*/
select
stg.account_type ,
stg.account_type_aop ,
stg.accountam ,
...
/*Below query fetches records which does not matches rule conditions, and keeps such records as it is*/
...
stg.endcustomermarket as endcustomermarket,
case 
    when stg.billtocustomername = sp1_ex.billto_customer_name then sp1_ex.end_customer_name
		else stg.endcustomername
...
stg.Class_code
from @DB_LEVEL@_na_cld_osc_gold.invoice_na_stg stg 
left outer join @DB_LEVEL@_edm_other_src_silver.americas_channel_comission_sp1_dop_claim_exemption sp1_ex
on stg.salesofficenumber = cast(sp1_ex.office_id as string)
and (stg.invoicedate >= sp1_ex.project_rollout_start_date and stg.invoicedate <= sp1_ex.project_rollout_end_date)
and stg.sp1productflag = 'TRUE'
and sp1_ex.asap_conflict_check_outcome like 'Approved%'
;

13. Rule7_temp_to_stg
...
WHERE billtocustomername NOT LIKE "%Ingram Micro%" and
billtocustomername NOT LIKE "%Tech Data%" and
billtocustomername NOT LIKE "%CDW%" and
billtocustomername NOT LIKE "%SYNNEX%" and
billtocustomername NOT LIKE "%Graybar%"
union all
select
119_override
,accountam
...
16. populate_commission_data_na
